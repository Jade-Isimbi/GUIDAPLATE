import { Activity, Database, FlaskConical, Shield, ChevronRight, BookOpen, Utensils, Heart, Globe, Award, ArrowRight } from 'lucide-react';
...
const metrics = [
  { label: 'Rwandan Foods', value: '247', sub: 'in our database', color: '#2E86AB', icon: Database },
  { label: 'Nutrients Tracked', value: '12', sub: 'key biomarkers', color: '#27AE60', icon: FlaskConical },
  { label: 'CKD Stages', value: '5', sub: 'G1 through G5', color: '#F39C12', icon: Shield },
  { label: 'Risk Assessments', value: '1.4k', sub: 'evaluations completed', color: '#E74C3C', icon: Activity },
];
